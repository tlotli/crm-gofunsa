                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group {{ $errors->has('franchise_id') ? 'has-error' : '' }}">
                                            <label class="control-label mb-10 text-left">Select Franchise</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create_button" class="btn btn-success mt-10"><span class="fa fa-plus"></span> Download Template</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route('franchise_quantities_sold')}}" method="post" enctype="multipart/form-data">
                                @csrf
