                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                {{--@foreach($site as $s)--}}
                                    <li  role="presentation" class="active"><a  href="{{route('site_contacts' , ['id' => $site->id])}}" aria-expanded="false">Contacts</a></li>
                                {{--@endforeach--}}
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <div class="panel panel-default card-view panel-refresh">
                                                ...
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="pull-left">
                                                        {{--@foreach($site as $s)--}}
                                                            <a href="{{route('site_create_contacts' ,['id' => $site->id])}}" class="pull-right btn btn-success  mr-15"><span class="fa fa-plus"></span> Capture Contact</a>
                                                        {{--@endforeach--}}
                                                    </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <div id="datable_1_wrapper" class="dataTables_wrapper no-footer"><table id="datable_1" class="table  display table-hover border-none dataTable no-footer" role="grid">
                                                                        ...
                                                                        <tr role="row">
                                                                            ...
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 272px;">Contact Name</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 101px;">Contact Phone</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 92px;">Contact Email</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 92px;">Position</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 126px;">Action </th>
                                                                        </thead>

                                                                        <tbody>

                                                                        @foreach($site_contacts as $s)
                                                                            <tr role="row" class="odd">
                                                                                ...
                                                                                <td>
                                                                                    {{--@foreach($site as $sites)--}}
                                                                                        <a href="{{route('edit_site_contact' , ['id' => $s->id , 'site_id' => $site->id])}}"  title="" data-original-title="Edit Contact" data-toggle="tooltip"> <span class="fa fa-pencil"></span></a>
                                                                                    {{--@endforeach--}}
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
