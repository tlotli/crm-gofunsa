    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        {!! $sites_owned_by_group_by_franchise_bar_chart->html() !!}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        {!! $sites_owned_by_group_by_region_franchise_bar_chart->html() !!}
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="datable_1" class="table table-hover display  pb-30" >
                                    ...
                                    @foreach($detail_reports as $d)
                                        <tr>
                                            ...
                                            <td>{{$d->province}}</td>
                                            <td><a href="{{route('visitations_list' , ['id' => $d->site_id])}}" data-original-title="View Site" data-toggle="tooltip"> <span style="margin-left: 10px" class="  fa fa-eye"></span></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
