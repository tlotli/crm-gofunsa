        ...
        <div class="col-lg-12 col-sm-12">
            <div class="panel panel-default card-view">
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Capture Stock Sold </h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            {{--@foreach($site as $s)--}}
                                <form action="{{route('store_quantity_sold' , ['id' => $site->id])}}" method="post">
                            {{--@endforeach--}}
                                @csrf
                                <div class="row ">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('quantity_sold') ? 'has-error' : '' }}">
                                            ...
                                            <input id="quantity_sold" type="number" class="form-control" name="quantity_sold" value="{{old('quantity_sold')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create" type="submit" class="btn btn-success mt-10"><span class="fa fa-plus"></span> Capture Stock Sold</button>
                                            {{--@foreach($site as $s)--}}
                                                <a href="{{route('capture_quantity_sold_list' ,['id' => $site->id])}}" class="btn btn-primary mt-10"><span class="fa fa-arrow-left"></span> Back </a>
                                            {{--@endforeach--}}
                                        </div>
                                    </div>
                                </div>
