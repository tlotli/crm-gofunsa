                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h5 class="panel-title txt-dark mb-10">
                            Edit Role <span ><a id="demo" data-demo=""  class="fa fa-question-circle-o"></a></span>
                        </h5>
                    </div>
                        ...
                        <div class="form-wrap">
                            <form action="{{route('roles.update' , ['id' => $role->id])}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('permission_id') ? 'has-error' : '' }}">
                                            <label class="control-label mb-10 text-left">Permissions For Retail Groups </label>
                                            @foreach($permissions as $p)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('permission_id') ? 'has-error' : '' }}">
                                            <label class="control-label mb-10 text-left">Permissions For Tasks</label>
                                            @foreach($permissions as $p)
                                                @if($p->permission_type_id == 13)
                                                    <div class="checkbox checkbox-primary">
                                                        <input id="{{$p->id}}" name="permission_id[]" value="{{$p->id}}" type="checkbox"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('permission_id') ? 'has-error' : '' }}">
                                            <label class="control-label mb-10 text-left">Permissions For Invoices</label>
                                            @foreach($permissions as $p)
                                                @if($p->permission_type_id == 16)
                                                    <div class="checkbox checkbox-primary">
                                                        <input id="{{$p->id}}" name="permission_id[]" value="{{$p->id}}" type="checkbox"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create_button" class="btn btn-success mt-10"><span class=" fa fa-pencil-square"></span> Edit Role</button>
