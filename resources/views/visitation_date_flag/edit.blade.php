            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            <form action="{{route('update_date' , ['id' => $set_date->id])}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('date_flag') ? 'has-error' : '' }}">
                                            <label class="control-label mb-10 text-left">Visitation Date Flag</label>
                                            <input type="number" class="form-control" name="date_flag" id="date_flag" value="{{$set_date->date_flag}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create_button" class="btn btn-success mt-10"><span class="fa fa-plus"></span> Update Date</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
