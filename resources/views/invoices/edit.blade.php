        ...
        <div class="col-lg-12 col-sm-12">
            <div class="panel panel-default card-view">
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Edit Invoice </h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            {{--@foreach($site as $s)--}}
                                <form action="{{route('update_invoice' , ['id' => $invoice->id , 'site_id' => $site->id ])}}" method="post" enctype="multipart/form-data">
                            {{--@endforeach--}}
                                    @csrf
                                    <div class="row ">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('who_invoiced') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control" name="who_invoiced" value="{{$invoice->who_invoiced}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('date_invoiced') ? 'has-error' : '' }}">
                                                ...
                                                <input id="date_invoiced" type="date" class="form-control" name="date_invoiced" value="{{$invoice->date_invoiced}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                                                ...
                                                <input type="number" class="form-control" name="quantity" value="{{$invoice->quantity}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('vat') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control" name="vat" value="{{$invoice->vat}}">
                                                @if ($errors->has('vat'))
                                                    <span class="text-danger" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                                ...
                                                <select name="status" id="" class="form-control">
                                                    @if($invoice->status == 0)
                                                            <option value="0" selected>Invoiced</option>
                                                            <option value="1">Not Invoiced</option>
                                                        @else
                                                            <option value="0">Invoiced</option>
                                                            <option value="1" selected>Not Invoiced</option>
                                                    @endif
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button id="create" class="btn btn-success mt-10"><span class="fa fa-pencil"></span> Update Invoice</button>
                                                {{--@foreach($site as $s)--}}
