                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                @foreach($site as $s)
                                    <li role="presentation"   class="active"><a  id="profile_tab_10" href="{{route('invoices.index' , ['id' => $s->id])}}" aria-expanded="false">Invoices</a></li>
                                @endforeach
                                                ...
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="pull-left">
                                                        @can('invoices.create' , \Illuminate\Support\Facades\Auth::user())
                                                            @foreach($site as $s)
                                                                <a href="{{route('invoice_create' ,['id' => $s->id])}}" class="pull-right btn btn-success  mr-15"><span class="fa fa-plus"></span> Capture Invoices</a>
                                                            @endforeach
                                                        @endcan
                                                    </div>
                                                                                ...
                                                                                <tr role="row" class="odd">
                                                                                    ...
                                                                                    <td>
                                                                                        @can('invoices.update' , \Illuminate\Support\Facades\Auth::user())
                                                                                            @foreach($site as $s)
                                                                                                <a href="{{route('edit_invoice' , ['id' => $i->id , 'site_id' => $s->id])}}"> <span class="fa fa-pencil"></span></a>
                                                                                            @endforeach
                                                                                        @endcan
                                                                                    </td>
                                                                                </tr>
