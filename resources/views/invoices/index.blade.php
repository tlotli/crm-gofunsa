                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                {{--@foreach($site as $s)--}}
                                    <li role="presentation"   class="active"><a  id="profile_tab_10" href="{{route('invoices.index' , ['id' => $site->id])}}" aria-expanded="false">Invoices</a></li>
                                {{--@endforeach--}}
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <div class="panel panel-default card-view panel-refresh">
                                                ...
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="pull-left">
                                                        @can('invoices.create' , \Illuminate\Support\Facades\Auth::user())
                                                            {{--@foreach($site as $s)--}}
                                                                <a href="{{route('invoice_create' ,['id' => $site->id])}}" class="pull-right btn btn-success  mr-15"><span class="fa fa-plus"></span> Capture Invoices</a>
                                                            {{--@endforeach--}}
                                                        @endcan
                                                    </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <div id="datable_1_wrapper" class="dataTables_wrapper no-footer"><table id="datable_1" class="table  display table-hover border-none dataTable no-footer" role="grid">
                                                                        ...
                                                                        <tr role="row">
                                                                            ...
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 92px;">Invoiced By</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 101px;">Date Invoiced</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 92px;">VAT</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 126px;">Quantity</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 126px;">Status</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 126px;">Attachment</th>
                                                                        ...
                                                                        <tbody>
                                                                            @foreach($invoices as $i)
                                                                                <tr role="row" class="odd">
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="{{ Storage::disk('local')->url($i->invoice_attachment) }}"  title="" data-original-title="View Attachement" data-toggle="tooltip"> <span class="fa fa-file-o"></span></a>
                                                                                    </td>
                                                                                    <td>
                                                                                        @can('invoices.update' , \Illuminate\Support\Facades\Auth::user())
                                                                                            {{--@foreach($site as $s)--}}
                                                                                                <a href="{{route('edit_invoice' , ['id' => $i->id , 'site_id' => $site->id])}}"> <span class="fa fa-pencil"></span></a>
                                                                                            {{--@endforeach--}}
                                                                                        @endcan
                                                                                    </td>
                                                                                </tr>
