            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h5 class="panel-title txt-dark mb-10">
                            Edit Product Price <span ><a id="demo" data-demo=""  class="fa fa-question-circle-o"></a></span>
                        </h5>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            <form action="{{route('set_price.update' , ['id' => $price->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('price ') ? 'has-error' : '' }}">
                                            ...
                                            <input type="number" step=".01" class="form-control" name="price" id="price" value="{{$price->price}}">
                                            @if ($errors->has('price'))
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create_button" class="btn btn-success mt-10"><span class="fa fa-pencil-square"></span> Edit Price</button>
                                        </div>
                                    </div>
                                </div>
