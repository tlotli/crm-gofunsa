                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                @foreach($site as $s)
                                    <li  role="presentation" class="active"><a  href="{{route('visitations_list' , ['id' => $s->id])}}" aria-expanded="false">Visitations</a></li>
                                @endforeach
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <div class="panel panel-default card-view panel-refresh">
                                                ...
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="pull-left">
                                                        @foreach($site as $s)
                                                            <a href="{{route('create_visitation' ,['id' => $s->id])}}" class="pull-right btn btn-success  mr-15"><span class="fa fa-plus"></span> Capture Visitation</a>
                                                        @endforeach
                                                    </div>
