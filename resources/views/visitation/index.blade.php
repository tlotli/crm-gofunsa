                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                {{--@foreach($site as $s)--}}
                                    <li  role="presentation" class="active"><a  href="{{route('visitations_list' , ['id' => $site->id])}}" aria-expanded="false">Visitations</a></li>
                                {{--@endforeach--}}
                                                            ...
                                                            <div class="table-responsive">
                                                                <div id="datable_1_wrapper" class="dataTables_wrapper no-footer"><table id="datable_1" class="table  display table-hover border-none dataTable no-footer" role="grid">
                                                                        ...
                                                                        <tr role="row">
                                                                            ...
                                                                            {{--<th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 101px;">No Days Since Visit</th>--}}
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 92px;">Visit By</th>
                                                                            <th class="sorting" tabindex="0" aria-controls="datable_1" rowspan="1" colspan="1"  style="width: 126px;">Type Of Visit </th>
                                                                        </thead>
                                                                        <tbody>
