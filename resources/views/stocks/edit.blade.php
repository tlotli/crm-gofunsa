        ...
        <div class="col-lg-12 col-sm-12">
            <div class="panel panel-default card-view">
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Edit Stock On Hand </h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            @foreach($site as $s)
                                <form action="{{route('update_soh' , ['id' => $soh->id , 'site_id' => $s->id])}}" method="post">
                            @endforeach
                                @csrf
                                <div class="row ">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('soh') ? 'has-error' : '' }}">
                                            ...
                                            <input id="soh" type="number" class="form-control" name="soh" value="{{$soh->soh}}">
                                            @if ($errors->has('soh'))
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create" type="submit" class="btn btn-success mt-10"><span class="fa fa-pencil-square"></span> Edit SOH</button>
                                            @foreach($site as $s)
                                                <a href="{{route('soh_list' ,['id' => $s->id])}}" class="btn btn-primary mt-10"><span class="fa fa-arrow-left"></span> Back </a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
