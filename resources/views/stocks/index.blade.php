                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-struct custom-tab-1 mt-40">
                            <ul role="tablist" class="nav nav-tabs" id="myTabs_7">
                                ...
                                @foreach($site as $s)
                                    <li  role="presentation" class="active"><a  id="profile_tab_8" href="{{route('soh_list' , ['id' => $s->id])}}" aria-expanded="false">Manage Stock On Hand</a></li>
                                @endforeach
                                            ...
                                            <div class="panel-heading">
                                                ...
                                                <div class="pull-left">
                                                    ...
                                                    {{--@can('stock_sold.create' , \Illuminate\Support\Facades\Auth::user())--}}
                                                        @foreach($site as $s)
                                                            <a href="{{route('capture_soh' ,['id' => $s->id])}}" class="pull-right btn btn-success  mr-15"><span class="fa fa-plus"></span> Capture SOH</a>
                                                        @endforeach
                                                    {{--@endcan--}}
                                                                    ...
                                                                    <tr role="row" class="odd">
                                                                        ...
                                                                        <td>
                                                                            @foreach($site as $sites)
                                                                             <a href="{{route('edit_soh' , ['id' => $s->id , 'site_id' => $sites->id])}}"  title="" data-original-title="Edit Stock" data-toggle="tooltip"> <span class="fa fa-pencil"></span></a>
                                                                            @endforeach
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
