            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                            <form action="{{route('franchise.update' , ['id' => $franchise->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" value="{{$franchise->name}}">
                                            @if ($errors->has('name'))
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="create_button" class="btn btn-success mt-10"><span class="fa fa-plus"></span> Edit Franchise</button>
